...
| Collision: hull construction + geometry (sphere/capsule/hull queries) | ✅ | ✅ (test_hull.c + test_shape geometry) |
| Collision: manifolds, mesh/compound/height field, dynamic_tree | ⬜ | ⬜ |
