# Pre-commit check script for Box3D Rust Port
...
Write-Host "🔍 Running pre-commit checks for Box3D Rust Port..." -ForegroundColor Cyan
...
if ($exitCode -eq 0) {
    ...
    Write-Host "   Your Box3D Rust code is ready for commit." -ForegroundColor Green
} else {
