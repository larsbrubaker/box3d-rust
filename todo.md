...
Merge-conflict warning: task-2 and task-3 add passes to
`src/solver/solve.rs` (bullet pass, sensor-hits report) and
task-2 touches `src/solver/integrate.rs`. Land whichever finishes
