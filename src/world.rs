...
///
/// C passes manifold pointers; the Rust signature will tighten when the collide
/// slice wires events. For the data model we keep shape ids + context.
pub type PreSolveFcn = fn(ShapeId, ShapeId, u64) -> bool;
