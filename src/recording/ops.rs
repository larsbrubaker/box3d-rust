...
impl RecOp {
    pub fn from_u8(v: u8) -> Option<Self> {
        match v {
            ...
            0x3A => Some(Self::BodyAllowFastRotation),
            ...
            0x5D => Some(Self::ShapeSetMeshMaterial),
            0x5E => Some(Self::ShapeSetHull),
            0x5F => Some(Self::ShapeSetMesh),
