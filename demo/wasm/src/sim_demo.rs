...
use box3d_rust::shape::{create_capsule_shape, create_compound_shape, create_hull_shape, create_sphere_shape};
...
/// Continuous / Thin Wall — `sample_continuous.cpp` ThinWall.
#[wasm_bindgen]
...
/// Continuous / Bounce House — `sample_continuous.cpp` BounceHouse.
#[wasm_bindgen]
pub fn sim_reset_bounce_house() -> u32 {
    SIM.with(|cell| {
        ...
        let wall_specs: [(Vec3, f32, f32, f32); 4] = [
            (Vec3 { x: 10.0, y: 5.0, z: 0.0 }, 0.1, 5.0, 10.0),
            (Vec3 { x: -10.0, y: 5.0, z: 0.0 }, 0.1, 5.0, 10.0),
            (Vec3 { x: 0.0, y: 5.0, z: -10.0 }, 10.0, 5.0, 0.1),
            (Vec3 { x: 0.0, y: 5.0, z: 10.0 }, 10.0, 5.0, 0.1),
        ];
        for (p, hx, hy, hz) in wall_specs {
            let transform = Transform { p, q: QUAT_IDENTITY };
...
/// Continuous / Bullet vs Stack — `sample_continuous.cpp` BulletVersusStack.
#[wasm_bindgen]
