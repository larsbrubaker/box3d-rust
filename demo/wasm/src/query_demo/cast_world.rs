...
mod tests {
    ...
    fn spawn_counts_and_destroy_match_c_buttons() {
        ...
        assert_eq!(query_add_shapes(5, 10), 10, "Spheres × 10");
        assert_eq!(query_add_shapes(0, 10), 20, "Capsules × 10");
        assert_eq!(query_add_shapes(3, 10), 30, "Hulls × 10");
        assert_eq!(query_add_shapes(4, 1), 31, "Meshes × 1");
        assert_eq!(query_add_shapes(2, 1), 32, "Height Field × 1");
